...
def run(t,res,plant):
    ...
    if c.t == datetime(1993,4,21):
            i=0
            print_watercontent_comparision(i)            
    if c.t == datetime(1993,5,3):
            i=1
            print_watercontent_comparision(i)
    if c.t == datetime(1993,6,14):
            i=2
            print_watercontent_comparision(i)
    if c.t == datetime(1993,6,28):
            i=3
            print_watercontent_comparision(i)
    if c.t == datetime(1993,7,13):
            i=4
            print_watercontent_comparision(i)
    if c.t == datetime(1993,8,3):
            i=5
            print_watercontent_comparision(i)
    if c.t == datetime(1993,8,17):
            i=6
            print_watercontent_comparision(i)
    if c.t == datetime(1993,8,31):
            i=7
            print_watercontent_comparision(i)
    if c.t == datetime(1993,9,21):
            i=8
            print_watercontent_comparision(i)
    if c.t == datetime(1993,7,12):
            i=9
            print_watercontent_comparision(i)
    if c.t == datetime(1994,3,8):
            i=10
            print_watercontent_comparision(i)
    if c.t == datetime(1994,4,19):
            i=11
            print_watercontent_comparision(i)
    if c.t == datetime(1994,5,27):
            i=12
            print_watercontent_comparision(i)
    if c.t == datetime(1994,6,15):
            i=13
            print_watercontent_comparision(i)
    if c.t == datetime(1994,7,27):
            i=14
            print_watercontent_comparision(i)
    if c.t == datetime(1994,9,21):
            i=15
            print_watercontent_comparision(i)
    if c.t == datetime(1994,11,30):
            i=16
            print_watercontent_comparision(i)
    if c.t == datetime(1995,3,13):
            i=17
            print_watercontent_comparision(i)
    if c.t == datetime(1995,4,26):
            i=18
            print_watercontent_comparision(i)
    if c.t == datetime(1995,6,7):
            i=19
            print_watercontent_comparision(i)
    if c.t == datetime(1995,7,17):
            i=20
            print_watercontent_comparision(i)
    if c.t == datetime(1996,4,22):
            i=21
            print_watercontent_comparision(i)
    if c.t == datetime(1996,8,26):
            i=22
            print_watercontent_comparision(i)
    if c.t == datetime(1997,5,5):
            i=23
            print_watercontent_comparision(i)
    if c.t == datetime(1997,10,1):
            i=24
            print_watercontent_comparision(i)
    if c.t == datetime(1998,7,29):
            i=25
            print_watercontent_comparision(i)
