...
def load_Parameter_settings(Parameter,Random_Van_Genuchten_Parameter=None):
    Parameter_default_alpha=0.05
    Parameter_default_n=2
    Parameter_default_porosity=0.4
    Parameter_default_ksat=12.5
        
    if Parameter == 'alpha':
        Parameter_minimum = 0.001
        Parameter_maximum = 0.1
        Parameter_default_alpha = Random_Van_Genuchten_Parameter

    if Parameter=='n':
        Parameter_minimum = 1
        Parameter_maximum = 4
        Parameter_default_n=Random_Van_Genuchten_Parameter

    if Parameter=='porosity':
        Parameter_minimum = 0.3
        Parameter_maximum = 0.7
        Parameter_default_porosity=Random_Van_Genuchten_Parameter

    if Parameter=='ksat':
        Parameter_minimum = 0.1
        Parameter_maximum = 25
        Parameter_default_ksat=Random_Van_Genuchten_Parameter
        
    #else:
        #print 'Error: Unknown Parameter input'        
    return Parameter_minimum, Parameter_maximum, Parameter_default_alpha, Parameter_default_n, Parameter_default_porosity, Parameter_default_ksat
    ...
    #Cropvalues.RUE=RUE_Faktor+1
        ...
        for Random_Van_Genuchten_Parameter_values in range(5652):
            try:
                ...
                #c=get_soil_data(Plot,Ksat=Random_Van_Genuchten_Parameter,porosity=0.45,alpha=0.05,n=1.5)

                #Create Random Parameterset for Van-Genuchten-Parameter
#                ksat     =load_Parameter_settings(Van_Genuchten_Parameter,Random_Van_Genuchten_Parameter)[5]
#                alpha    =load_Parameter_settings(Van_Genuchten_Parameter,Random_Van_Genuchten_Parameter)[2]
#                n        =load_Parameter_settings(Van_Genuchten_Parameter,Random_Van_Genuchten_Parameter)[3]
#                porosity =load_Parameter_settings(Van_Genuchten_Parameter,Random_Van_Genuchten_Parameter)[4]

                #All Calculated local Maxima
                #ksat = 0.1368
                #alpha = 0.0056
                #n = 1.3412
                #porosity = 0.4956
                ...
                #Van-Genuchten-Values used in Hydrus-1D
                #ksat = 30
                #alpha = 0.147
                #n = 2.8
                #porosity = 0.43
...
#            
            #=======================================Watercontent==========================================
                ...
                if Parameter == 'Water_Content':
                    ...
                    ###########Plot1##########################
                    #if Plot==1:
                    #print 'Saving results for Paramter '+Parameter+' with '+str(Van_Genuchten_Parameter)+str(Random_Van_Genuchten_Parameter)
                    Messung=[]
                    ...
                    ###########Plot2##########################
#                        if Plot==2:                
#                            print 'Saving results for Paramter '+Parameter+' on Plot = '+str(Plot)+'with  '+str(Van_Genuchten_Parameter)+str(Random_Van_Genuchten_Parameter)
#                            Messung=[]
#                            Messung.append(datetime(1993,4,21)-start)
#                            Messung.append(datetime(1993,5,3)-start)
