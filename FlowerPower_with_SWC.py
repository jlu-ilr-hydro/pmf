def run(t,res,plant):
    ...
    ETc = plant.et.Cropspecific if plant else baresoil.transpiration
    ...
    soil(ETc,evaporation,rainfall,Zr)
...
if __name__=='__main__':
    ...
    grid()
    subplot(313)
    plot(res.stress,label="Water strees")
    legend(loc=0)
    show()
